...
<div class="wrap sfwppa-settings-form-settings">
	...
	<h2><?php esc_html_e( 'Styles For Pagenavi Settings', 'styles-for-wp-pagenavi-addon' ); ?></h2><br />
			...
			<div class="meta-box-sortables ui-sortable">
				<div id="general" class="postbox">
					...
					<div class="postbox-header">
						<!-- Settings box title -->
						<h2 class="hndle">
							<span><?php esc_html_e( 'General Settings', 'styles-for-wp-pagenavi-addon' ); ?></span>
						</h2>
					</div>	
						...
						<table class="form-table sfwppa-general-sett-tbl">
							<tbody>
								<tr>
                                    <th scope="row">
                                        <label for="mpp-default-thumbnail"><?php esc_html_e('Select Style', 'styles-for-wp-pagenavi-addon'); ?>:</label>
                                    </th>
                                    <td>
	                                    <?php
								...
								<tr>
									<th scope="row">
										<label for="sfwppa-default-title"><?php esc_html_e('Font Size', 'styles-for-wp-pagenavi-addon'); ?>:</label>
									</th>
									<td>
										...
										<span class="description"><?php esc_html_e('Select font size. Leave empty for default font size 12px.', 'styles-for-wp-pagenavi-addon'); ?></span>
									</td>
								</tr><!-- Font Size -->

								<tr>
									<th scope="row">
										<label for="sfwppa-post-title-clr"><?php esc_html_e('Font Color', 'styles-for-wp-pagenavi-addon'); ?>:</label>
									</th>
									<td>
										...
										<?php } else { ?>
											<div style='position:relative;'>
												...
												<input type="button" class="sfwppa-color-box-farbtastic button button-secondary" value="<?php esc_attr_e('Select Color', 'styles-for-wp-pagenavi-addon'); ?>" />
												<div class="colorpicker" style="background-color: #666; z-index:100; position:absolute; display:block;"></div>
											</div>
										<?php } ?>
											
											<span class="description"><?php esc_html_e('Select Fonts Color. Leave empty for default color.', 'styles-for-wp-pagenavi-addon'); ?></span>
									</td>
								</tr><!--Font Color -->

								<tr>
									<th scope="row">
										<label for="sfwppa-post-title-clr"><?php esc_html_e(' Border Color', 'styles-for-wp-pagenavi-addon'); ?>:</label>
									</th>
									<td>
										<?php if( $wp_version >= 3.5 ) { ?>
										...
										<?php } ?>
											...
											<span class="description"><?php esc_html_e('Select Border Color. Leave empty for border color.', 'styles-for-wp-pagenavi-addon'); ?></span>
									</td>
								</tr><!-- border color -->

								<tr>
									<th scope="row">
										<label for="sfwppa-post-title-clr"><?php esc_html_e('Active Background Color', 'styles-for-wp-pagenavi-addon'); ?>:</label>
									</th>
									<td>
										<?php if( $wp_version >= 3.5 ) { ?>
										...
										<?php } ?>
											...
											<span class="description"><?php esc_html_e('Select Active Background Color. Leave empty for default active background color.', 'styles-for-wp-pagenavi-addon'); ?></span>
									</td>
								</tr><!-- Active Background Color -->

								<tr>
									<th scope="row">
										<label for="sfwppa-post-title-clr"><?php esc_html_e('Hover Background Color', 'styles-for-wp-pagenavi-addon'); ?>:</label>
									</th>
									<td>
										<?php if( $wp_version >= 3.5 ) { ?>
										...
										<?php } ?>
											...
											<span class="description"><?php esc_html_e('Select Hover Background Color. Leave empty for default hover background color.', 'styles-for-wp-pagenavi-addon'); ?></span>
									</td>
								</tr><!-- Hover Background Color -->

								<tr>
									<th scope="row">
										<label for="sfwppa-post-title-clr"><?php esc_html_e('Active Text Color', 'styles-for-wp-pagenavi-addon'); ?>:</label>
									</th>
									<td>
										<?php if( $wp_version >= 3.5 ) { ?>
										...
										<?php } ?>
											...
											<span class="description"><?php esc_html_e('Select Active Text Color. Leave empty for default active text color.', 'styles-for-wp-pagenavi-addon'); ?></span>
									</td>
								</tr><!-- Active Text Color -->

								<tr>
									<th scope="row">
										<label for="sfwppa-post-title-clr"><?php esc_html_e('Hover Text Color', 'styles-for-wp-pagenavi-addon'); ?>:</label>
									</th>
									<td>
										<?php if( $wp_version >= 3.5 ) { ?>
										...
										<?php } ?>
											...
											<span class="description"><?php esc_html_e('Select Hover Text Color. Leave empty for default hover text color.', 'styles-for-wp-pagenavi-addon'); ?></span>
									</td>
								</tr><!-- Menu Title Color -->

								<tr>
									<td colspan="2" valign="top" scope="row">
										<input type="submit" id="sfwppa-settings-submit" name="sfwppa-settings-submit" class="button button-primary right" value="<?php esc_attr_e('Save Changes','styles-for-wp-pagenavi-addon'); ?>" />
									</td>
								</tr>
							</tbody>
						 </table>
